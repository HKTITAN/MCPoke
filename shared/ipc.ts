import type { AuthViewModel, LogEntry, ServerRegistryItem, ServerViewModel, PortConfig, McpToolDescriptor } from './mcp-types.js'

/** IPC channel names and contracts for the preload bridge */
export const IPC = {
  /** subscribe via onAuthChanged */
